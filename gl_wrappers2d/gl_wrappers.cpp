...
void Quad::set_vec2_uniform(const char *name, const float *v) {
    GLuint loc = glGetUniformLocation(program, name);
    glUniform2f(loc, v[0], v[1]);
}

void Quad::set_vec2_uniform(const char *name,
...
void Quad::set_vec2_uniforms(const std::map<std::string, 
                                                            std::pair<float, 
                                                                    float> 
                                                        > &uniforms) {
...
void Quad::set_vec3_uniform(const char *name,
                                            const std::vector<float> &v) {
    GLuint loc = glGetUniformLocation(program, name);
...
void Quad::set_vec4_uniform(const char *name,
                                            const std::vector<float> &v) {
    GLuint loc = glGetUniformLocation(program, name);
